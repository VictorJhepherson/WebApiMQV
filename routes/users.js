...
router.post('/insert', upload.single('USR_PHOTO'), login, UserController.insertUsers);
...
router.patch('/photo', upload.single('USR_PHOTO'), login, UserController.updatePhoto);
